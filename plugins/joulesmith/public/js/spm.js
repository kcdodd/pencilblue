var spm = function() {
    ...
    // loss_multiplier: basically, factor to over-estimate losses to give margin of error to design
        ...
        var heating_power = 2.0*total_loss*(1.0-self_heating);

        // assuming heating efficiency is around 50%, and some of the lost power will be recovered as thermal energy
        var net_power = total_power*thermal_eff - heating_power*(1-thermal_eff);
        ...
        return {
            ...
            'diff_frac' : diff_loss/total_loss,
            'brem_frac': brem_loss/total_loss,
            'cusp_frac': cusp_loss/total_loss
        };
    };
