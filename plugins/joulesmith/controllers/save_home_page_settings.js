...
module.exports = function SaveHomePageSettingsModule(pb) {
    ...
    SaveHomePageSettings.prototype.render = function(cb) {
        ...
        this.getJSONPostParams(function(err, post) {
            ...
            var dao = new pb.DAO();
            dao.q('joulesmith_theme_settings', opts, function(err, homePageSettings) {
                if (util.isError(err)) {
                ...
                if(homePageSettings.length > 0) {
                    ...
                    homePageSettings = pb.DocumentCreator.create('joulesmith_theme_settings', post);
    ...
    SaveHomePageSettings.getRoutes = function(cb) {
        var routes = [
            {
                method: 'post',
                path: '/actions/admin/plugins/settings/joulesmith/home_page',
                auth_required: true,
